...
// ── Servidor web — igual que v2 pero con Socket.IO ──────────────
...
function createBot() {
  ...
  bot.once('spawn', () => {
    ...
    modeManager.init(bot, panel.addAlert, (mode) => panel.updateMode(mode));
  ...
  // Todos los mensajes del servidor → panel + authme
  ...
  bot.on('kicked', reason => console.warn('[Bot] Expulsado:', reason));
}
